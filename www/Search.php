                ...
                <tr>
                    <td class="alt">
                        <form action="Search.php" method="post">
                            ...
                            <script>
                                // Code copied from :
                                // https://stackoverflow.com/questions/6028576/
                                // how-to-clear-a-form
                                function resetForm(form) {
                                    ...
                                    // clearing textarea
                                    var text= form.getElementsByTagName(
                                            'textarea'
                                            );
